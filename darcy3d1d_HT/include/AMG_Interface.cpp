...
void AMG::solve(void)
{
    ...
    // ===> Set primary parameters. Others can be set by access functions as shown below.
      ...
      APPL_INT    idump     = -1;        // no output

	  // iout page 44 Userguide. it controls display outpu. default 2 (display residuals per iteration and work statistics) very verbose 43			
      APPL_INT    iout      = -1; // no output
