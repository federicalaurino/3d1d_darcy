...
/*! 
  ...
  @date   2019.
  @brief  SAMG library interface to use AMG solver
 */
  ...
  AMG::AMG(gmm::csr_matrix<scalar_type> A_csr, std::vector <scalar_type> F, int solver){
      std::cout<<"Build class AMG " << std::endl;
  ...
  void AMG::solve() {
    ...
    // Setting SAMG parameters
      ...
      // =====================================================================================
      // Choose the type of solver = 0 -> direct solver
      //                           = 1 -> AMG stand alone
      //                           = 2 -> AMG accelerated

      if (solver_ == 0){  // Use samg direct solver
        std::cout << " Using SAMG Direct solver " << std::endl;
      ...
      else if (solver_ == 1){ //AMG stand alone
        ...
        std::cout << " Using AMG as a stand alone solver " << std::endl;
      ...
      else{ // AMG accelerated
        std::cout << " Using AMG accelerated " << std::endl;
        ncyc      = 11050;    // V-cycle as pre-conditioner for CG; at most 50 iterations	
      }
